import{r as n,j as e,L as pe,$ as he,S as C}from"./app-DjD40Phh.js";import{A as ue,F as ge}from"./app-layout-6VnQPzEo.js";import{B as o}from"./button-C3HkFPC7.js";import{I as je}from"./input-D9FPgVPY.js";import{L as m}from"./label-C2ljXs9V.js";import{C as be,S as p,a as h,b as u,c as g,d as a}from"./select-C8dRgRsH.js";import{T as ye,a as fe,b as T,c as d,d as Ne,e as i}from"./table-_iJt8AYv.js";import{S as ve}from"./surat-jalan-modal-C2UyfQbo.js";import{D as we}from"./date-range-picker-CIkQdKuo.js";import{F as W}from"./filter-p40wYjc0.js";import{C as _e}from"./chevron-down-D6BvewSX.js";import{P as Q}from"./printer-C1palqwM.js";import{B as Se}from"./boxes-DpohvRiX.js";import{C as ke,R as Ce}from"./rotate-ccw-CRYAF7hD.js";import{a as Te}from"./index-BlzobzNc.js";import{R as X}from"./receipt-DLf6EXYl.js";import{S as De}from"./search-B9w6R-B2.js";import{C as $e}from"./circle-check-Dd4GCJwo.js";import{E as Pe}from"./eye-off-E0hNY84N.js";import{E as ze}from"./eye-786-SKoP.js";/* empty css            */import"./index-DQsLrUSK.js";import"./Combination-Yt2ngHDs.js";import"./index-DkxCJ21Q.js";import"./app-logo-icon-SV0GxNfM.js";import"./index-wGPO34I4.js";import"./check-BXkN55MV.js";import"./dialog-B0CY59ah.js";import"./file-text-DTpckn0i.js";import"./calendar-asjF9FlA.js";import"./chevron-left-DjuyLfj5.js";const Ie=[{title:"Dashboard",href:"/dashboard"},{title:"Report",href:"/reports"}];function ot({reports:r,kpi:l,customers:D,shippers:$,service_types:Z,filters:c}){const[f,P]=n.useState(c.customer_id||"all"),[N,z]=n.useState(c.shipper_id||"all"),[b,I]=n.useState(c.service_type||"all"),[_,R]=n.useState(c.price_type||"all"),[v,F]=n.useState(c.date_from||""),[w,L]=n.useState(c.date_to||""),[E,A]=n.useState(c.date_type||"entry_date"),[B,K]=n.useState(c.exclude_status||"active"),[O,M]=n.useState(c.invoice_status||"all"),[H,U]=n.useState(c.search||""),[V,J]=n.useState(String(c.per_page||25)),[S,ee]=n.useState(!0),[te,Y]=n.useState(!1),[ae,se]=n.useState(null),k=t=>{C.get(route("reports.index"),{customer_id:(t==null?void 0:t.customer_id)!==void 0?t.customer_id:f==="all"?void 0:f,shipper_id:(t==null?void 0:t.shipper_id)!==void 0?t.shipper_id:N==="all"?void 0:N,service_type:(t==null?void 0:t.service_type)!==void 0?t.service_type:b==="all"?void 0:b,price_type:(t==null?void 0:t.price_type)!==void 0?t.price_type:_==="all"?void 0:_,date_from:(t==null?void 0:t.date_from)!==void 0?t.date_from:v||void 0,date_to:(t==null?void 0:t.date_to)!==void 0?t.date_to:w||void 0,date_type:(t==null?void 0:t.date_type)!==void 0?t.date_type:E,exclude_status:(t==null?void 0:t.exclude_status)!==void 0?t.exclude_status:B,invoice_status:(t==null?void 0:t.invoice_status)!==void 0?t.invoice_status:O,search:(t==null?void 0:t.search)!==void 0?t.search:H||void 0,per_page:(t==null?void 0:t.per_page)!==void 0?t.per_page:V},{preserveState:!0,preserveScroll:!0})},le=()=>{P("all"),z("all"),I("all"),R("all"),F(""),L(""),A("entry_date"),K("active"),M("all"),U(""),J("25"),C.get(route("reports.index"),{},{preserveScroll:!0})},ne=t=>{t.key==="Enter"&&k()},ie=t=>{se({container_number:t.container_number,size:t.size||"20ft",customer_name:t.customer_name,shipper_name:t.shipper_name,service_type:t.service_type,commodity:t.commodity,no_aju:t.no_aju,order_id:t.order_id,date:t.exit_date||t.entry_date}),Y(!0)},j=t=>{if(!t)return"-";try{const x=new Date(t);return isNaN(x.getTime())?t:x.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})}catch{return t}},re=()=>{var q,G;if(r.data.length===0){alert("Tidak ada data laporan untuk dicetak.");return}const t=window.open("","_blank","width=1100,height=800");if(!t){alert("Popup terblokir oleh browser. Harap izinkan popup.");return}const x=((q=D.find(s=>String(s.id)===f))==null?void 0:q.name)||"Semua Customer",y=((G=$.find(s=>String(s.id)===N))==null?void 0:G.name)||"Semua Shipper",de=b==="all"?"Semua Layanan":b,ce=v||w?`${j(v)} s/d ${j(w)}`:"Semua Periode",xe=new Date().toLocaleDateString("id-ID",{day:"2-digit",month:"long",year:"numeric",hour:"2-digit",minute:"2-digit"}),oe=r.data.map((s,me)=>`
            <tr>
                <td style="text-align: center;">${me+1}</td>
                <td><strong>${s.customer_name}</strong></td>
                <td>${s.shipper_name}</td>
                <td>${s.service_type}</td>
                <td style="font-weight: bold;">${s.container_number}</td>
