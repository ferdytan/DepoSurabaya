import{r as h,K as Y,j as e,L as X,S as b,$ as Q}from"./app-DSLnk1Hu.js";import{A as V,X as Z}from"./app-layout-CEOqrUXw.js";import{D as ee,a as te,b as ae,c as se,d as re}from"./dialog-CEeOA61R.js";import{B as x}from"./button-Bm_K9u3k.js";import{I as O}from"./input-RWFGO0xx.js";import{L as w}from"./label-DHeEoHSL.js";import{T as ne,a as ie,b as T,c as p,d as le,e as d}from"./table-C6uB2mlU.js";import{D as oe}from"./date-range-picker-Dnz8ENCW.js";import{D as de}from"./date-time-picker-f27Sa5CV.js";import{P as ce}from"./printer-D_MEwrZ5.js";import{C as me}from"./circle-plus-CMRwOszc.js";import{A as xe,a as pe,b as ge}from"./arrow-up-DXkL6ufE.js";/* empty css            */import"./index-BOIHd-Ji.js";import"./Combination-NJMHr0zg.js";import"./index-gSajBfnd.js";import"./index-UNVHIpVR.js";import"./app-logo-icon-DszJehIQ.js";import"./calendar-CvDWmDL6.js";import"./chevron-down-dyCkxedf.js";import"./rotate-ccw-CfKLWYdA.js";import"./chevron-left-ChhOP0Ur.js";import"./check-DrhqzWs3.js";import"./clock-Bg9_leHM.js";const he=[{title:"Karantina",href:"/karantina"}];function z(g,y){if(!g)return y||"-";const n=String(g).trim();return n.toLowerCase().endsWith("ft")?n:n==="20"||n==="40"?`${n}ft`:n||y||"-"}function Ie({orders:g,filters:y}){var L,A;const n=y||{},[v,C]=h.useState(n.search??""),[c,P]=h.useState(n.start_date??""),[m,$]=h.useState(n.end_date??""),[I,D]=h.useState(!1),[K,B]=h.useState(null),[S,f]=h.useState([]),u=g.data.filter(t=>!c&&!m?!0:[t.entry_date,t.eir_date,t.exit_date].some(s=>{if(!s)return!1;const i=new Date(s),l=c?new Date(c):null,N=m?new Date(m):null;return!(l&&i<l||N&&i>N)})),U=(t,a)=>{f(r=>{const s=[...r];return s[t].date=a,s})},H=(t,a,r)=>{f(s=>{const i=[...s];return i[t].temps={...i[t].temps||{},[a.toString().padStart(2,"0")]:r},i})},M=()=>{f(t=>[...t,{date:"",temps:{}}])},W=t=>{f(a=>a.filter((r,s)=>s!==t))},q=()=>{if(!K)return;const t={};S.forEach(a=>{a.date&&(t[a.date]=a.temps)}),console.log("Data yang dikirim ke backend:",t),b.patch(route("orders.update-temperature",K.id),{temperature:t},{onSuccess:()=>{D(!1),B(null),f([]),b.reload({only:["orders"]})},onError:a=>{alert("Terjadi error saat menyimpan data suhu."),console.error(a)}})};h.useEffect(()=>{console.log("Semua data orders:",g.data)},[g.data]);const G=()=>{if(u.length===0){alert("Tidak ada data yang sesuai filter untuk dicetak.");return}const t=c?new Date(c).toLocaleDateString("id-ID"):"Semua",a=m?new Date(m).toLocaleDateString("id-ID"):"Semua",r=`${t} s/d ${a}`,s="/logo.png",i=new Image;i.src=s;const l=window.open("","_blank");if(!l){alert("Gagal membuka jendela cetak. Pastikan popup tidak diblokir.");return}l.document.write(`
