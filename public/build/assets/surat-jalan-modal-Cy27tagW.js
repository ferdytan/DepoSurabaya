import{c as T,B as K}from"./button-Da-5rs5K.js";import{r as l,j as e}from"./app-ILod_Tra.js";import{D as V,a as Z,b as Q,c as ee}from"./dialog-iABKj6hg.js";import{I as r}from"./input-D8PGuDv0.js";import{L as o}from"./label-DJ7IKiDs.js";import{F as te}from"./file-text-MpexTebb.js";import{P as ae}from"./printer-DGQ5zSb6.js";/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const se=[["rect",{width:"18",height:"7",x:"3",y:"3",rx:"1",key:"f1a2em"}],["rect",{width:"9",height:"7",x:"3",y:"14",rx:"1",key:"jqznyg"}],["rect",{width:"5",height:"7",x:"16",y:"14",rx:"1",key:"q5h2i8"}]],ie=T("LayoutTemplate",se);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=[["path",{d:"M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z",key:"q3az6g"}],["path",{d:"M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8",key:"1h4pet"}],["path",{d:"M12 17.5v-11",key:"1jc1ny"}]],fe=T("Receipt",le);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=[["path",{d:"M21 10.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.5",key:"1uzm8b"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]],oe=T("SquareCheckBig",re);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ne=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]],de=T("Square",ne);function ve({isOpen:A,onClose:C,data:a}){const G=l.useRef(null);function _(t){try{const i=new Date(t);if(isNaN(i.getTime()))return t;const s=String(i.getDate()).padStart(2,"0"),n=String(i.getMonth()+1).padStart(2,"0"),c=i.getFullYear();return`${s} - ${n} - ${c}`}catch{return t}}const R=t=>{if(!t)return'1 X 20"';const i=t.toLowerCase();return i.includes("45")?'1 X 45"':i.includes("40")?'1 X 40"':i.includes("20")?'1 X 20"':`1 X ${t}`},[h,E]=l.useState(""),[g,L]=l.useState(""),[b,P]=l.useState(""),[f,z]=l.useState(""),[v,$]=l.useState("-"),[u,I]=l.useState("FULL CONT(ON-CHASIS)"),[j,M]=l.useState("-"),[m,O]=l.useState(""),[w,U]=l.useState(()=>R(a==null?void 0:a.size)),[y,D]=l.useState(()=>(a==null?void 0:a.service_type)||"PLUG & MONITORING TEMPERATURE"),[p,Y]=l.useState(!1),[N,H]=l.useState("modern");l.useEffect(()=>{if(a){const t=new Date,i=String(t.getDate()).padStart(2,"0"),s=String(t.getMonth()+1).padStart(2,"0"),n=t.getFullYear(),c=String(t.getHours()).padStart(2,"0"),S=String(t.getMinutes()).padStart(2,"0");E(a.date?_(a.date):`${i} - ${s} - ${n}`),L(a.exit_time||`${c}:${S}`),P(a.police_number||""),z(a.destination||""),$(a.seal_number||"-"),I(a.commodity?a.commodity.toUpperCase():"FULL CONT(ON-CHASIS)"),M(a.notes||"-"),O(a.container_number||""),U(R(a.size)),D(a.service_type||"PLUG & MONITORING TEMPERATURE")}},[a,A]);const B=w,J=y||(a==null?void 0:a.service_type)||"PLUG & MONITORING TEMPERATURE",k=(a==null?void 0:a.customer_name)||"-",d=(a==null?void 0:a.shipper_name)||null,q=()=>{const t=p?`<img src="${window.location.origin}/logo.png" class="depo-logo" alt="Logo" style="height: 35px; max-height: 35px; width: 42px; max-width: 42px; object-fit: contain; margin-right: 8px;" />`:"";return N==="modern"?`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
