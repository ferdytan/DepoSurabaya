import{r as l,j as e}from"./app-BRRlMXAe.js";import{D as V,a as Q,b as Z,c as ee}from"./dialog-CQqsmTGf.js";import{c as T,B as K}from"./button-CwqcVMa4.js";import{I as r}from"./input-lFe8FTlW.js";import{L as o}from"./label-BRhVb0lp.js";import{F as te}from"./file-text-uq81KCiU.js";import{P as ae}from"./printer-DgLoMX8V.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=[["path",{d:"M21 10.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.5",key:"1uzm8b"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]],re=T("SquareCheckBig",le);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oe=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]],ne=T("Square",oe);function be({isOpen:A,onClose:C,data:a}){const G=l.useRef(null);function _(t){try{const i=new Date(t);if(isNaN(i.getTime()))return t;const s=String(i.getDate()).padStart(2,"0"),n=String(i.getMonth()+1).padStart(2,"0"),c=i.getFullYear();return`${s} - ${n} - ${c}`}catch{return t}}const E=t=>{if(!t)return'1 X 20"';const i=t.toLowerCase();return i.includes("45")?'1 X 45"':i.includes("40")?'1 X 40"':i.includes("20")?'1 X 20"':`1 X ${t}`},[h,L]=l.useState(""),[g,P]=l.useState(""),[b,z]=l.useState(""),[f,R]=l.useState(""),[v,$]=l.useState("-"),[u,O]=l.useState("FULL CONT(ON-CHASIS)"),[j,I]=l.useState("-"),[m,H]=l.useState(""),[w,M]=l.useState(()=>E(a==null?void 0:a.size)),[y,U]=l.useState(()=>(a==null?void 0:a.service_type)||"PLUG & MONITORING TEMPERATURE"),[p,Y]=l.useState(!1),[N,D]=l.useState("modern");l.useEffect(()=>{if(a){const t=new Date,i=String(t.getDate()).padStart(2,"0"),s=String(t.getMonth()+1).padStart(2,"0"),n=t.getFullYear(),c=String(t.getHours()).padStart(2,"0"),S=String(t.getMinutes()).padStart(2,"0");L(a.date?_(a.date):`${i} - ${s} - ${n}`),P(a.exit_time||`${c}:${S}`),z(a.police_number||""),R(a.destination||""),$(a.seal_number||"-"),O(a.commodity?a.commodity.toUpperCase():"FULL CONT(ON-CHASIS)"),I(a.notes||"-"),H(a.container_number||""),M(E(a.size)),U(a.service_type||"PLUG & MONITORING TEMPERATURE")}},[a,A]);const B=w,J=y||(a==null?void 0:a.service_type)||"PLUG & MONITORING TEMPERATURE",k=(a==null?void 0:a.customer_name)||"-",d=(a==null?void 0:a.shipper_name)||null,q=()=>{const t=p?`<img src="${window.location.origin}/logo.png" class="depo-logo" alt="Logo" style="height: 35px; max-height: 35px; width: 42px; max-width: 42px; object-fit: contain; margin-right: 8px;" />`:"";return N==="modern"?`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
