...
export default function CreateProduct() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Produk Layanan Baru" />
                ...
                <div className="w-full space-y-6 pb-12">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Daftarkan jenis layanan baru di depo, tentukan apakah memerlukan monitoring rekam suhu, serta keterangannya.
                            </p>
                        </div>
                    ...
                    <div className="max-w-3xl rounded-xl border border-gray-200 bg-white p-6 sm:p-8 shadow-xs">
                        <div className="flex items-center gap-2.5 pb-4 border-b border-gray-100 mb-6">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-gray-900">Informasi Produk Layanan</h3>
                                <p className="text-xs text-gray-500">Lengkapi informasi nama dan karakteristik layanan di bawah ini</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-100">
                                ...
                                >
                                    ...
                                    {processing ? 'Menyimpan Produk...' : 'Simpan Produk Baru'}
                                </Button>
                            </div>
                        </form>
                    </div>
